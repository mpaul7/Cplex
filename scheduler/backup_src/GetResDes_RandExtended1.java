...
public class GetResDes_RandExtended1 {
	...
	public GetResDes_RandExtended1(int nMD){
		this.nMD = nMD;
	...
	public GetResDes_RandExtended1(int nMD, int nSN, double[][]MDResDes){
		this.nSN = nSN;
		this.nMD = nMD;
	...
	public void case1(int mthMD, int appType){
		...
		MDResDes[3][mthMD] = Tp;
		MDResDes[4][mthMD] = Ts;import ilog.concert.IloNumVarType;
import java.lang.Math;
...
public class GetResDes_RandExtended1 {
	...
	public void case10(int mthMD, int appType){
		...
		int latencyLocal = randInt(7, 10);
		double Tp = (double)latencyLocal/4;
		setLatencyParameters(input, outputimport ilog.concert.IloNumVarType;
		import java.lang.Math;
...
public class GetResDes_RandExtended {
  ...
  */ //=============================================
  ...
  public static double[] randDouble(int col, double min, double max) {
	  ...
	  //for (double lng : RV_ar
	  public class GetResDes_RandExtended1 {

	  }
ray) {System.out.println(lng);} // for
	  return rvDouble;
	  }
