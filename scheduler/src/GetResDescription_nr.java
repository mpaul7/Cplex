...
public class GetResDescription_nr {
	...
	public double[][] energyRemote(){
		double[][] energyRemote = {{1, 2}, {3, 4}, {5, 6}};
	...
	public double[][] rhoMN(){
		//double[][] rhoMN = {{30, 10}, {60, 40}, {50, 30}};
		double[][] rhoMN = {{30, 10}, {23, 20}, {21, 12}};
		//double[][] rhoMN = {{30, 10}, {60, 40}, {50, 30}};
	...
	//=====================================================
		...
		public double[] alphaN(){
			//double[] alphaN = {91, 41, 51};
			double[] alphaN = {91, 91, 91};
			//double[] alphaN = {91, 41, 51};
			/*for (int eleIndex = 0; eleIndex< nSN; eleIndex++){
				rhoN [eleIndex] = 600.0;
			}*/
		...
		public double[][] alphaMN(){
			double[][] alphaMN = {{40, 50}, {35, 25}, {37, 36}};
			/*//double[][] rhoMN = randDoubleDouble(nSN, nMD, 30, 90);
			for (int c = 0; c< nMD; c++){
				for (int r = 0; r< nSN; r++){
					rhoMN [r][c]= procPower[c];
