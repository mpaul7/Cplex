...
public class GetResDes_Random {
	...
	public GetResDes_Random(int nMD){
		this.nMD = nMD;
	...
	public GetResDes_Random(int nMD, int nSN, double[][]MDResDes){
		this.nSN = nSN;
		this.nMD = nMD;
  ...
  */ //=============================================
  ...
  public static void main(String args[]){
	 // GetResDes_Random obj = new GetResDes_Random(10);
